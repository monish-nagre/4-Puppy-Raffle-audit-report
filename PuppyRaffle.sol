...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        //  Storage variable in a loop should be cached.
    ...
    function refund(uint256 playerIndex) public {
        ...
        players[playerIndex] = address(0);  // here the re-enterancy attack happen: cause state upadte after the external call.
    ...
    function getActivePlayerIndex(address player) external view returns (uint256) {
        for (uint256 i = 0; i < players.length; i++) {
            ...
            // q : what if the player is at 0 ?
            // @audit if the player is at index 0 , it will return 0 and a player might think that they are not active!
        }
        return 0;
    }
    ...
    function selectWinner() external {
        ...
        // @audit randomness PRNG
        // fixes : Chainlink VRF (varifiable random function) generated 
        // IMPACT : HIGH 
        uint256 winnerIndex =
        ...
        // @audit randomness (same issue as above)
        ...
        // @audit possible re-entrancy attack 
